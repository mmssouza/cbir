...
#leaves = ["1386.png","1397.png"]
#leaves = ["3298.png","3299.png"]
lt = ["k-","k--"]
label=["i1453","i1480"]
...
for i in enumerate(leaves):
 idx = i[0]
 d1 = descritores.angle_seq_signature(path+i[1],5,120.0).sig
...
pylab.savefig("graf_assinaturas_angle.png",dpi=200)
pylab.show()
